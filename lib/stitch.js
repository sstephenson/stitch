(function() {
  var CoffeeScript, Package, async, compilers, eco, extname, fs, isWindows, join, normalize, _, _ref,
  ...
  exports.Package = Package = (function() {
    ...
    function Package(config) {
      ...
      this.excludes = (_ref5 = config.excludes) != null ? _ref5 : [];
    ...
    Package.prototype.walkTree = function(directory, callback) {
      ...
      return fs.readdir(directory, function(err, files) {
        ...
        return async.forEach(files, function(file, next) {
          ...
          if ((__indexOf.call(_this.excludes, filename) >= 0) || file.match(/^\./)) {
            return next();
          }
