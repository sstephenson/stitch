(function() {
  var CoffeeScript, Package, async, basename, compilers, dirname, eco, extname, fs, join, normalize, sep, _, _ref,
  ...
  _ref = require('path'), basename = _ref.basename, dirname = _ref.dirname, extname = _ref.extname, join = _ref.join, normalize = _ref.normalize, sep = _ref.sep;
  ...
  exports.Package = Package = (function() {
    ...
    function Package(config) {
      ...
      var path, _ref2, _ref3, _ref4;
      this.identifier = (_ref2 = config.identifier) != null ? _ref2 : 'require';
      this.filtered = {};
      this.paths = (function() {
        var _i, _len, _ref3, _ref4, _results;
        _ref4 = (_ref3 = config.paths) != null ? _ref3 : ['lib'];
        _results = [];
        for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
          path = _ref4[_i];
          _results.push(this.setupFilterFor(path) || path);
        }
        return _results;
      }).call(this);
    ...
    Package.prototype.walkTree = function(directory, callback) {
      ...
      return fs.readdir(directory, function(err, files) {
        ...
        return async.forEach(files, function(file, next) {
          ...
          if (_this.filtered[directory] && _this.filtered[directory](filename) === false) {
            return next();
          }
    ...
    Package.prototype.setupFilterFor = function(path) {
      var directory, escapedDirectoryParts, escapedSubdirectories, name, pattern, subdirectories;
      if (this.definesFilter(path)) {
        directory = dirname(path);
        subdirectories = basename(path).split(",");
        escapedDirectoryParts = (function() {
          var _i, _len, _ref2, _results;
          _ref2 = directory.split(sep);
          _results = [];
          for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
            name = _ref2[_i];
            _results.push(this.escapePatternMatchCharacters(name));
          }
          return _results;
        }).call(this);
        escapedSubdirectories = (function() {
          var _i, _len, _results;
          _results = [];
          for (_i = 0, _len = subdirectories.length; _i < _len; _i++) {
            name = subdirectories[_i];
            _results.push(this.escapePatternMatchCharacters(name));
          }
          return _results;
        }).call(this);
        pattern = new RegExp("^" + (escapedDirectoryParts.join(sep)) + sep + "(" + (escapedSubdirectories.join('|')) + ")");
        this.filtered[directory] = function(filename) {
    ...
    Package.prototype.definesFilter = function(path) {
      return /,/.test(basename(path));
    };

    Package.prototype.escapePatternMatchCharacters = function(string) {
