(function() {
  ...
  exports.Package = Package = (function() {
    ...
    function Package(config) {
      ...
      this.ignore = (_ref5 = config.ignore) != null ? _ref5 : [];
    ...
    Package.prototype.walkTree = function(directory, callback) {
      ...
      return fs.readdir(directory, function(err, files) {
        ...
        return async.forEach(files, function(file, next) {
          var filename, ignore, k, _ref2;
          if (file.match(/^\./)) return next();
          filename = join(directory, file);
          _ref2 = _this.ignore;
          for (k in _ref2) {
            ignore = _ref2[k];
            if (ignore.test(filename)) return next();
          }
          return fs.stat(filename, function(err, stats) {
            var _ref3;
            _this.mtimeCache[filename] = stats != null ? (_ref3 = stats.mtime) != null ? _ref3.toString() : void 0 : void 0;
