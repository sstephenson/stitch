  ...
  exports.Package = Package = (function() {
    ...
    function Package(config) {
      var _ref1, _ref2, _ref3, _ref4,
        _this = this;
      this.compileSources = function(callback) {
        return Package.prototype.compileSources.apply(_this, arguments);
      };
      this.compileDependencies = function(callback) {
        return Package.prototype.compileDependencies.apply(_this, arguments);
      };
