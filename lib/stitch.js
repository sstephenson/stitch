(function() {
  var CoffeeScript, Package, async, basename, compilers, dirname, eco, extname, fs, join, normalize, _, _ref,
  ...
  _ref = require('path'), basename = _ref.basename, dirname = _ref.dirname, extname = _ref.extname, join = _ref.join, normalize = _ref.normalize;
  ...
  exports.Package = Package = (function() {
    ...
    Package.prototype.setupFilterFor = function(path) {
      var directory, pattern, suffixes;
