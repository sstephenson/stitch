(function() {
  var Module, Package, async, extname, fs, join, normalize, stitch, _, _ref;
  ...
  module.exports = Package = (function() {
    ...
    Package.prototype.compileFile = function(path, callback) {
      var compiler;
      compiler = this.extensions[extname(path)];
      return Module.load(path, compiler, function(err, mod) {
        return callback(err, mod != null ? mod.source : void 0);
      });
    };
